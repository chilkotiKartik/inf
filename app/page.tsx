  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <div ref={targetRef} className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-main-content">
          <motion.div
            ref={heroRef}
      ...
      <div className="py-24 bg-gradient-to-br from-primary/5 via-purple-500/5 to-pink-500/5 relative overflow-hidden">
        {/* Background Elements */}
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute top-0 left-0 w-96 h-96 bg-primary/10 rounded-full filter blur-3xl animate-pulse" />
          <div className="absolute bottom-0 right-0 w-80 h-80 bg-purple-500/10 rounded-full filter blur-3xl animate-pulse" />
        </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <motion.div
            ...
            transition={{ duration: 0.8 }}
          >
            <Badge className="mb-6 bg-gradient-to-r from-primary/20 to-purple-500/20 text-primary border-primary/30 text-lg px-8 py-3 backdrop-blur-sm">
            ...
            <p className="text-muted-foreground text-xl mb-12 max-w-3xl mx-auto leading-relaxed">
              Be part of a community that's shaping the future of technology. Connect with brilliant minds, work on 
              groundbreaking projects, and make your mark in the world of innovation.
            </p>
              ...
              {!user ? (
                <>
                  <Link href="/signup">
                    <Button
                      size="lg"
                      className="rounded-full px-12 py-6 text-lg bg-gradient-to-r from-primary to-purple-600 hover:from-primary/90 hover:to-purple-600/90 shadow-2xl shadow-primary/25 transform hover:scale-105 transition-all duration-300"
                    >
                      <Users className="mr-3 h-6 w-6" />
                      Join Community
                    </Button>
                  ...
                  <Link href="/projects">
                    <Button
                      variant="outline"
                      size="lg"
                      className="rounded-full px-12 py-6 text-lg border-2 border-primary/50 hover:bg-primary/10 backdrop-blur-sm"
                    >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto">
              {[
                { icon: <Users className="h-8 w-8" />, value: "500", label: "Active Members", suffix: "+" },
                { icon: <Code className="h-8 w-8" />, value: "150", label: "Live Projects", suffix: "+" },
                { icon: <Award className="h-8 w-8" />, value: "50", label: "Awards Won", suffix: "+" },
                { icon: <Globe className="h-8 w-8" />, value: "25", label: "Countries", suffix: "+" },
              ].map((stat, index) => (
                <motion.div
                  key={index}
